...
class GRUActorCritic(nn.Module):
    """Same architecture as LSTM variant but GRU replaces LSTM — no cell state."""
...
def main():
    ...
    ap.add_argument("--out",          type=str,   default="weights_gru_logger.pth")
    ap.add_argument("--load",         type=str,   default=None)
    ap.add_argument("--run_name",     type=str,   default="ppo_gru")
