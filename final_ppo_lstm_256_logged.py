...
Example:
  python train_ppo_lstm.py --obelix_py ./obelix.py --out weights.pth --episodes 500 --difficulty 3
"""
...
def main():
    ...
    ap.add_argument("--out",          type=str,   default="final_weights_ppo_lstm_256_plot.pth")
    ap.add_argument("--episodes",     type=int,   default=500)
    ap.add_argument("--max_steps",    type=int,   default=200)
    ap.add_argument("--difficulty",   type=int,   default=3)
    ap.add_argument("--run_name",     type=str,   default="ppo_lstm_256")
    ...
    for ep in tqdm(range(args.episodes), desc="Training"):
        ...
        if ep_reward > best_reward:
            ...
            tqdm.write(
                f"  ✓ Episode {ep+1} | New best: {best_reward:.1f} — saved")
