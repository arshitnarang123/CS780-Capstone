...
def main():
    ...
    ap.add_argument("--out", type=str, default="weights_recurrent_ppo_v3_param_update.pth")
    ...
    ap.add_argument("--update_epochs", type=int, default=2)
    ap.add_argument("--ent_coef", type=float, default=0.02)
    ap.add_argument("--vf_coef", type=float, default=0.7)
    args = ap.parse_args()
